...
class SkiCanvasLmsApiCaller {
    ...
    static async getRequest(
        ...
        const requestUrl =
            endpointUrl instanceof URL ? endpointUrl : new URL(endpointUrl);
        ...
        return await fetch(requestUrl)
            ...
            .then((data) => {
                ...
                const responseResults = new SkiCanvasLmsApiResponse(
                    requestResponse,
                    data,
                    resultPropertySelector
                );
                if (SKI_DEBUG_MODE) {
...
//     static async getRequestAllPages(
//         endpointUrl,
//         params = {},
//         resultPropertySelector = null
//     ) {
//         const firstPageResponse = await SkiCanvasLmsApiCaller.getRequest(
//             endpointUrl,
//             params,
//             resultPropertySelector
//         );
...
//         if (!firstPageResponse.hasNextPage()) {
//             return firstPageResponse.results;
//         }

//         if (firstPageResponse.isNumericPagination()) {
//             return await SkiCanvasLmsApiCaller.#getRemainingPagesNumbers(
//                 firstPageResponse,
//                 resultPropertySelector
//             );
//         } else {
//             return await SkiCanvasLmsApiCaller.#getRemainingPagesBookmarks(
//                 firstPageResponse,
//                 resultPropertySelector
//             );
//         }
...
//     static async #getRemainingPagesBookmarks(
//         firstPageResponse,
//         resultPropertySelector = null
//     ) {
...
//             const nextPageResponse = await SkiCanvasLmsApiCaller.getRequest(
//                 nextPageUrl,
//                 {},
//                 resultPropertySelector
//             );
//             const status = await SkiCanvasLmsApiCaller.#handlePageResponse(
//                 nextPageResponse,
//                 paginatedResults,
//                 resultPropertySelector,
//                 1
...
//                 if (SKI_DEBUG_MODE) {
//                     console.log("Retry attempts failed. Stopping pagination.");
//                 }
//                 break;
//             }
...
//     static async #getRemainingPagesNumbers(
//         firstPageResponse,
//         resultPropertySelector = null
//     ) {
...
//         let requests = [];
//         while (
//             lastPageNumber == SkiCanvasLmsApiResponse.UNKNOWN_LAST_PAGE_NUM ||
//             nextPageNumber <= lastPageNumber
//         ) {
//             const requestUrl = new URL(nextPageUrl);
//             requestUrl.searchParams.set("page", nextPageNumber);
//             requests.push(
//                 SkiCanvasLmsApiCaller.getRequest(requestUrl, {}, resultPropertySelector)
//             );
//             if (requests.length >= MAX_BATCH_SIZE) {
//                 await Promise.all(requests).then(async (responses) => {
//                     for (const response of responses) {
//                         const pageNumber = await SkiCanvasLmsApiCaller.#handlePageResponse(
//                             response,
//                             paginatedResults,
//                             resultPropertySelector,
//                             1
...
//                             if (SKI_DEBUG_MODE) {
//                                 console.log(
//                                     `Skipping request due to failed retries: ${response.url}`
//                                 );
//                             }
//                         } else if (
//                             lastPageNumber == SkiCanvasLmsApiResponse.UNKNOWN_LAST_PAGE_NUM &&
//                             pageNumber != SkiCanvasLmsApiResponse.UNKNOWN_LAST_PAGE_NUM
//                         ) {
...
//     static #addCurrentPageResultsToTotalResults(
//         currentPageResults,
//         totalPageResults
//     ) {
...
//     static async #handlePageResponse(
//         response,
//         totalPageResults,
//         resultPropertySelector = null,
//         attempt = 1
...
//             response.statusMessage?.toLowerCase().includes("rate limit exceeded")
//         ) {
//             if (SKI_DEBUG_MODE) {
//                 console.log("Rate limit was exceeded.");
//             }
...
//                 }
//                 const retryResponse = await SkiCanvasLmsApiCaller.getRequest(
//                     response.url,
//                     {},
//                     resultPropertySelector
//                 );
//                 attempt++;
//                 return await SkiCanvasLmsApiCaller.#handlePageResponse(
//                     retryResponse,
//                     totalPageResults,
//                     resultPropertySelector,
//                     attempt
...
//     static async getRequestsInBulk(
//         endpointUrl,
//         substitutionValues,
//         params = {},
//         resultPropertySelector = null
...
//                     currentEndpointUrl = currentEndpointUrl.replace(
//                         `/:${key}`,
//                         `/${currentValues[key]}`
//                     );
...
//             if (SKI_DEBUG_MODE) {
//                 console.log("Sending request as part of batch:");
//                 console.log(currentEndpointUrl);
//                 console.log(currentParams);
//             }
//             requests.push(
//                 SkiCanvasLmsApiCaller.getRequestAllPages(
//                     currentEndpointUrl,
//                     currentParams,
//                     resultPropertySelector
//                 )
...
//         this.statusMessage = SkiCanvasLmsApiResponse.#getStatusMessage(
//             response,
//             responseJson
//         );
...
//         this.results = SkiCanvasLmsApiResponse.#getResponseResults(
//             responseJson,
//             resultPropertySelector
//         );
//     }
...
//     isNumericPagination() {
//         if (!this.hasNextPage() && !this.hasLastPage()) {
//             return false;
//         }
...
//     getNextPageNumber() {
//         if (!this.hasNextPage()) {
//             return SkiCanvasLmsApiResponse.UNKNOWN_NEXT_PAGE_NUM;
//         }
//         if (!this.isNumericPagination()) {
//             return SkiCanvasLmsApiResponse.UNKNOWN_NEXT_PAGE_NUM;
//         }
...
//             SkiCanvasLmsApiResponse.UNKNOWN_NEXT_PAGE_NUM
//         );
//     }
...
//         return (
//             Number.parseInt(pageParam) ||
//             SkiCanvasLmsApiResponse.UNKNOWN_LAST_PAGE_NUM
//         );
//     }
}